...
% VERSION 3 : 
% variation du T : --> chercher le meilleur T qui donne le coût minimal
% ajout de la fonction aléatoire Weibull pour la génération 
...
fprintf("T = %d - Coût total = %d  - CMC = %d - CMP = %d \n", T, CMC, CMP, CoutTotal);


if(CoutTotal<CoutMin)    % mettre à jour le cout minimal
    CoutMin=CoutTotal;
    Tmin=T;
end
...
fprintf("Tmin = %d - Coût total min = %d \n", Tmin, CoutMin);
plot(Tab);
